# Supervised learning portion of my code
# I implement SVM
...
#sublienar_tf applied because if a term appears 20 times, the significance may not
#be 20 times of a single occurance
#use_idf controls for those values that are document specific
...
classifier_always = svm.SVC(probability=True, C = 1000)
classifier_always.fit(always_tfidf_train, always_label_train)
prediction_always = classifier_always.predict(always_tfidf_test)
print(classification_report(always_label_test, prediction_always))

# classifier_oralb = svm.SVC(probability=True, C = 1000)
# classifier_oralb.fit(oralb_tfidf_train, oralb_label_train)
# prediction_oralb = classifier_oralb.predict(oralb_tfidf_test)
#
# print(classification_report(oralb_label_test, prediction_oralb))

classifier_tampax = svm.SVC(probability=True, C = 1000)
classifier_tampax.fit(tampax_tfidf_train, tampax_label_train)
prediction_tampax = classifier_tampax.predict(tampax_tfidf_test)

print(classification_report(tampax_label_test, prediction_tampax))


classifier_gillette = svm.SVC(probability=True, C = 1000)
classifier_gillette.fit(gillette_tfidf_train, gillette_label_train)
prediction_gillette = classifier_gillette.predict(gillette_tfidf_test)

print(classification_report(gillette_label_test, prediction_gillette))


classifier_pantene = svm.SVC(probability=True, C = 1000)
classifier_pantene.fit(pantene_tfidf_train, pantene_label_train)
prediction_pantene = classifier_pantene.predict(pantene_tfidf_test)

print(classification_report(pantene_label_test, prediction_pantene))
